  ...
  return (
    <TouchableOpacity
      className={clsx("rounded-lg border-2 m-1", {
        ...
        ["bg-violet-500 border-violet-400"]: amountAccomplishedPercentage > 0 && amountAccomplishedPercentage < 20,
        ['bg-violet-600 border-violet-500']: amountAccomplishedPercentage >= 20 && amountAccomplishedPercentage < 40,
        ['bg-violet-700 border-violet-500']: amountAccomplishedPercentage >= 40 && amountAccomplishedPercentage < 60,
        ['bg-violet-800 border-violet-600']: amountAccomplishedPercentage >= 60 && amountAccomplishedPercentage < 80,
