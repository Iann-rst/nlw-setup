...
export function NewHabitForm() {
  ...
  function handleToggleWeekDayChecked(weekDay: number) {
  ...
  return (
    ...
    <form onSubmit={submitForm} className="w-full flex flex-col mt-6">
        ...
        {availableWeekDays.map((weekDay, index) => {
          return (
            <Checkbox.Root
              ...
              onCheckedChange={() => handleToggleWeekDayChecked(index)}
            >
